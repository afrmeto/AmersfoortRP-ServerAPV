# Amersfoort-Roleplay-server-APV
Welkom op de pagina voor de Wet- en Regelgeving van Amersfoort! Zorg ervoor, dat je voor je deelneemt aan Amersfoort, kennis hebt genomen van deze wetten.  De Algemene Plaatselijke Verordening (APV) bevat alle regels die niet te maken hebben met de Roleplay (dit zijn zogezegd de "server regels").
...
1. Deze Algemene Plaatselijke Verordening (verder aangeduid als APV) is bedoeld als aanvulling op het Nederlands Recht en heeft betrekking op het eiland, de gemeente, en de stad Noorderlicht.
...
1. Aanvullend op de APV is er het Wetboek Noorderlicht (WNL), waarin alle wetten, artikelen en bepalingen zijn opgenomen die gelden in Noorderlicht.
...
5. De bedragen en/of materialen zullen per direct teruggegeven worden aan de Hoge Raad. De Hoge Raad dient deze per direct te vernietigen.
...
2. Bij een overtreding van de regel genoemd in lid 1 zal de persoon erop gewezen worden volgende keer gelieve “/report” te gebruiken of een ticket aan te maken in de Discord.
...
1. Het gebruik van Out Of Character (OOC) chat is exclusief bedoeld voor het stellen van vragen over de server en/of GTA. Deze is niet bedoeld voor role-play gerelateerde zaken, gebruik hiervoor gelieve Twitter.
...
2. Hij/zij die zich schuldig maakt aan het stelen van overheidsvoertuigen als beschreven in lid 1 zal bestraft worden met een straf volgens categorie 1.
...
2. Er wordt geacht dat er voor het uitvoeren van je baan het voertuig wordt gebruikt dat is verstrekt door de baas.
...
2. Er moeten ten allen tijden vijf overheidsmedewerkers binnen een baan beschikbaar blijven nadat er één ontvoert is, dus als er 6 agenten aanwezig zijn mag er 1 ontvoert worden, als er 5 aanwezig zijn mag er geen ontvoert worden.
